...
"""
TEXT_PROMPT = "gate."
IMG_PATH = "/Users/peter/Documents/MDS_UBC/My Projects/Grounded_SAM/Labeling/dataset/gateseg/images/train/gate8_1.png"
...
TEXT_THRESHOLD = 0.25
DEVICE = "mps"
OUTPUT_DIR = LABELING_DIR / "outputs" / "grounded_sam2_local_demo"
...
if input_boxes is None or len(input_boxes) == 0:
    raise ValueError("No boxes detected for this image.")

# if tensor -> numpy
if hasattr(input_boxes, "cpu"):
...
for i, box in enumerate(input_boxes):
    print(f"Running SAM2 on box {i}: {box}")
